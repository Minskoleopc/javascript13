...
// let userInput
// do {
//     userInput = prompt('Please enter any value between 1 to 6') // 6
//     if (randomNumber == userInput) {
...
// let randomNumber2 = Math.floor(Math.random() * 6) + 1 // 1,2,3,4,5,6
// console.log(randomNumber2)
// let userInput2 = prompt('Enter the number between 1 to 6')
...
// let randomNumber2 = Math.floor(Math.random() * 6) + 1 // 6
// for(let i = 0 ; i < 5 ; i++){
//     let userInput2 = prompt('Enter the number between 1 to 6') //5
//     if(randomNumber2 == userInput2){
//         console.log('you guess is correct')
//         break
//     }
...
//     userInput2 = prompt('Enter the number between 1 to 6') // 6
